...
if uploaded_file is not None:
    ...
    if df.isnull().values.any():
        ...
        # 4.2 Bar plots for categorical columns (with top few categories)
        ...
        # Step 6: User queries for insights via Gemini
...
# Provide a message to encourage uploading a clean dataset
else:
